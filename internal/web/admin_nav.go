		...
		},
		{
			...
			SubMenus: []WebNavItem{
				...
				},
				{
					...
					Description: "Reference documentation for the server-side scripting API.",
					SubItems: []WebNavSub{
						{Label: "API Docs", Target: "/admin/scripting-api", Description: "REST API reference for the scripting engine."},
					},
				},
			},
		},
