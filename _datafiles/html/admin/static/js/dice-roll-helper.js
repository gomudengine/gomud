...
var DiceRollHelper = (function() {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            '.drh-toggle {',
            '  padding:0.35rem 0.55rem; border:1px solid #ccc; border-radius:4px;',
            '  background:#f5f5f5; cursor:pointer; font-size:0.82rem; line-height:1;',
            '  flex-shrink:0; font-family:monospace; font-weight:600; color:#555;',
            '}',
            '.drh-toggle:hover { background:#e8eaff; border-color:#7986cb; }',
            '.drh-toggle.active { background:#1a1a2e; color:#fff; border-color:#1a1a2e; }',
            '.drh-panel {',
            '  display:none; margin-top:0.5rem; padding:0.7rem 0.8rem;',
            '  background:#f9f9fb; border:1px solid #ddd; border-radius:6px;',
            '}',
            ...
            '.drh-group label {',
            '  font-size:0.68rem !important; font-weight:600; color:#888;',
            '  text-transform:uppercase; letter-spacing:0.04em; white-space:nowrap;',
            '}',
            '.drh-group input[type="number"] {',
            '  width:52px; padding:0.3rem 0.3rem; border:1px solid #ccc;',
            '  border-radius:4px; font-size:0.85rem; font-family:inherit; text-align:center;',
            '}',
            '.drh-sep {',
            '  font-size:1rem; font-weight:700; color:#999; padding-top:1rem;',
            '  user-select:none; flex-shrink:0;',
            '}',
            '.drh-preview {',
            '  margin-top:0.4rem; font-size:0.82rem; color:#555; font-family:monospace;',
            '}',
            '.drh-preview code {',
            '  background:#e8eaff; padding:0.15rem 0.4rem; border-radius:3px;',
            ...
            '  background:#e8eaf6; color:#3949ab; border-radius:3px;',
            ...
            '}',
            '.drh-chip button:hover { color:#c00; }',
            '.drh-add-buff {',
            '  font-size:0.75rem; padding:0.2rem 0.5rem; border:1px dashed #aaa;',
            '  border-radius:4px; background:#fff; cursor:pointer; color:#555;',
            '}',
            '.drh-add-buff:hover { border-color:#7986cb; color:#3949ab; background:#f0f0ff; }'
        ].join('\n');
